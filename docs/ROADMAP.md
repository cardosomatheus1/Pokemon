...
|---|---|---|
| **ST-12.8** · o bolo de faixa de duração | 26/09 | quatro faixas medidas em 10.000 lutas (21,9% · 22,8% · 29,9% · 25,5%), fixture `test/fixtures/duracao.json` conferida por um lote novo a cada suíte · a duração é a da luta paga (D-119) · aba "Duração" · a regra deixou de falar em dividir um empate que não existe (achado no OLHAR) · o Q2 achou um teste fraco (a raiz sorteada caía na faixa 0 em 22% das vezes) · S1294–S1298 |
| **D-119** · o servidor pagava uma luta sem clima | 26/09 | em 771 de 2.000 rodadas o campeão pago (aposta, XP, bolo) não era o que o jogador via vencer — o cliente aplicava o clima, o servidor não · agora `engine/luta-rodada.mjs`, uma função para os dois lados · nenhuma conta real afetada (o piloto não começou) · S1292–S1293 |
...
| 5 | **1.27g · UX-01** (resto) + o bloco do CENÁRIO · ~~ST-5.6~~ ✅, ~~ST-2.4~~ ✅, ~~D-110~~ ✅, 5.8 | L-175 ✅ (DEC-15), L-184 ✅, L-187 ✅, L-188 ✅, D-086 (não reproduzido) — o jato (L-186, ST-5.5b) fechou; o banner (D-082), o `est:` cru (L-160), a base visual (D-093), os números de dano (L-172, ST-5.4) e a carga e o projétil (L-171, ST-5.5) fecharam; os 404 (L-176) esperam o dono commitar os dois arquivos | o que impede ENTENDER a ação vem antes do que a enfeita |
...
| ~~**L-186**~~ | ✅ fechada na ST-5.5b (25/09): o jato do Surf, Flamethrower, Thunderbolt… | — |
