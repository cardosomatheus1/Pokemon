...
(26/09, sobre edb9670: 598 reavaliados, 651 reaproveitados). **O próximo
bloco é a ST-12.5** (o preço do modelo carimbado antes, publicado depois —
medido: lote próprio de 20.000 simulações com eventos, ~0,8 s).
