...
Liga). **O próximo bloco é a ST-12.10** (telemetria e o gate da V2); depois
12.7 (pódio) e 12.8 (duração), abertos só se a liquidez justificar (§6.5).
666 adiados para o próximo Q2 completo.
